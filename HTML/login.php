...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($sha1Contrasena, $hashAlmacenado)) {
            ...
            header("Location: contacto.php?nombreUsuario=" . urlencode($nombreUsuario));
...
<head>
    ...
    <title>Login - LinkHub CRM</title>
    <link rel="stylesheet" href="../CSS/login.css">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <style>
      
body {
background: url(../IMG/8.-Conceptos-y-definiciones-de-administración-1-scaled.jpg);
...
<body>
    ...
    <form action="login.php" method="POST">
            ...
            <br><br>
            <button onclick="window.location.href='index.php';" type="button" class="btn btn-secondary">Cambiar a Login Trabajadores</button>
        </form>
    </div>
