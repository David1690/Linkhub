        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item"><a class="nav-link" href="ventas.php">Regresar</a></li>
                </ul>
            </div>
        </nav>
...
<!-- Botón Eliminar -->
<button type="submit" name="action" value="eliminar" class="btn-custom" style="background-color: #dc3545; ">Eliminar</button>
