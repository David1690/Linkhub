    ...
    <div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="alta_empresas.php">Empresas</a></li>
                </ul>
            </div>
        </nav>
        <div class="lelo">
        <div id="ventas" class="mt-4">
            ...
            <form id="form-ventas" method="POST">
                ...
                <button class="btn btn-danger btn-custom" onclick="window.location.href='editar_ventas.php'">Editar</button>
            </form>
        </div>
    </div>
    </div>
